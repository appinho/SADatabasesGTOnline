...
if (!empty($_GET['accept_request'])) {
	...
	$email = mysqli_real_escape_string($connect, $_GET['accept_request']);
...
if (!empty($_GET['reject_request'])) {
	...
	$email = mysqli_real_escape_string($connect, $_GET['reject_request']);
...
if (!empty($_GET['cancel_request'])) {
	...
	$email = mysqli_real_escape_string($connect, $_GET['cancel_request']);
